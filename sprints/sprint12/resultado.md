...
| --------  | :----:   | :----:   | :----:  |
| Adrianne | Quase finalização do projeto, Integração continua funcionando perfeitamente, documentações sendo atualizadas | Apenas a comunicação e percepção da equipe bastante saturada com o projeto | Não se aplica |
...
![](../../images/metrics_agile/quadro_conhecimento_sprint12.png)
